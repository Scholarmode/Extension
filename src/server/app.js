...
app.get('/questions/video/:id', questions.getVideoQuestions)
...
app.put('/questions/:id/:accountId/unvote', questions.removeVote)
...
app.put('/replies/:id/:accountId/unvote', replies.removeVote)
